...
An `f64`-specific linear algebra operations using BLAS/LAPACK for `totsu`/`totsu_core`.
...
An `f32`-specific linear algebra operations using CUDA/cuBLAS/cuSOLVER for `totsu`/`totsu_core`.
