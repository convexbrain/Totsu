...
This crate for Rust provides **CUDA linear algebra** operations for [`totsu`](https://crates.io/crates/totsu)/[`totsu_core`].
...
* [`totsu_core::FloatGeneric<f32>`] can be replaced with [`F32CUDA`].
* You need a [NVIDIA CUDA Toolkit](https://developer.nvidia.com/cuda-downloads) to link
  because this crate uses `rustacuda`, `cublas-sys` and [`cusolver_sys_partial`].
